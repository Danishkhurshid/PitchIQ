...
archive contains 314 Pakistan Super League matches.

In this workspace, the raw match JSON files from this archive are stored under
`data/psl/raw/` so other leagues can be added later without mixing source
